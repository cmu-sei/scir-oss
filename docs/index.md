...
![Example](examples/oparest_example.svg)
...
[Click here to see the complete OPA REST-API report in Markdown](examples/oparest_scir.md)

For more information, check out the [Quickstart Guide](manuals/README-running.md).

## Installation

See the [Installation Instructions](manuals/README-install.md) or [Docker Installation Instructions](manuals/README-docker.md)

## License

OSS-P4/R is licensed under an MIT-style license, which can be
found in the [`LICENSE`](https://github.com/cmu-sei/scir-oss/blob/main/license.txt) file in this repository.
