...
| Current as of | Date: 09-05-2025 (project queried 0 days ago) |
...
| Stakeholder Criteria | <table class='wrapped' data-mce-resize='false'><colgroup><col/></colgroup><tbody>      <tr><td>Criteria</td><td style=''>Security (8.1)</td><td style=''>Integrity (1.9)</td><td style=''>Dependencies (0.0)</td><td style=''>Malicious Actors (10.0)</td><td style=''>Long-Term Support (3.8)</td><td style=''>Suitability (10.0)</td></tr><tr><td><hr style='border: 10px solid gray; border-radius: 5px'/></td></tr><tr><td>MY Checks</td><td style=''>Security (NaN)</td><td style=''>Integrity (NaN)</td><td style=''>Dependencies (NaN)</td><td style=''>Malicious Actors (10.0)</td><td style=''>Long-Term Support (10.0)</td><td style=''>Suitability (10.0)</td></tr><tr><td>OSSF Scorecard</td><td style=''>Security (6.2)</td><td style=''>Integrity (0.0)</td><td style=''>Dependencies (0.0)</td><td style=''>Malicious Actors (NaN)</td><td style=''>Long-Term Support (1.4)</td><td style=''>Suitability (10.0)</td></tr><tr><td>MITRE Hipcheck</td><td style=''>Security (10.0)</td><td style=''>Integrity (3.8)</td><td style=''>Dependencies (NaN)</td><td style=''>Malicious Actors (10.0)</td><td style=''>Long-Term Support (0.0)</td><td style=''>Suitability (NaN)</td></tr>  </tbody></table> |
| Summarized Scores By CIO Criteria |   <table class='wrapped' data-mce-resize='false'><colgroup><col/><col/><col/><col/><col/><col/><col/></colgroup><tbody>      <tr><td>Criteria:<br/></td><td>Security</td><td>Integrity</td><td>Dependencies</td><td>Malicious Actors</td><td>Long-Term Support</td><td>Suitability</td></tr><tr><td>MY Checks:<br/></td><td></td><td></td><td></td><td>Anonymous Author(0/0)<br/>Sanctioned Author(0/0)<br/></td><td>Project Forked(false/false)<br/>Problem Reporting(true/true)<br/>Project Abandoned(false/false)<br/>Dependent Projects Abandoned(0/0)<br/></td><td>Restrictive License(s)(0/0)<br/></td></tr><tr><td><a href='https://github.com/ossf/scorecard/blob/main/docs/checks.md'>OSSF Scorecard</a>:<br/>(higher's better) (x)3.3/10.0</td><td>Binary Artifacts(10/3.3)<br/>(x)Branch Protection(0/3.3)<br/>Dangerous Workflow(10/3.3)<br/>(x)Token Permissions(0/3.3)<br/>Vulnerabilities(10/3.3)<br/>(!)Webhooks(NaN/3.3)<br/></td><td>(x)Code Review(0/3.3)<br/>(!)CI Tests(NaN/3.3)<br/>(x)Fuzzing(0/3.3)<br/>(x)SAST(0/3.3)<br/>(!)Packaging(NaN/3.3)<br/>(!)Signed Releases(NaN/3.3)<br/></td><td>(x)Dependency Update Tool(0/3.3)<br/>(x)Pinned Dependencies(0/3.3)<br/></td><td></td><td>Contributors(10/3.3)<br/>(x)Maintained(0/3.3)<br/>(x)CII Best Practices(0/3.3)<br/>(x)Security Policy(0/3.3)<br/></td><td>License(10/3.3)<br/></td></tr><tr><td><a href='https://github.com/mitre/hipcheck/blob/hipcheck-v3.3.1/docs/book/src/using/analyses.md'>MITRE Hipcheck</a>:<br/>(score &le; threshold) (x)INVESTIGATE risk rated as 0.55, acceptable below or equal to 0.50</td><td>Binary Artifacts(0.0/0)<br/>Large Commits(0.0/0.02)<br/>Malware Entropy(0.0/0)<br/>(!)Typosquatting(NaN/true)<br/></td><td>(x)Self Reviews(0.9/0.2)<br/>(x)Fuzz Testing(false/true)<br/>Pull Reviews(0.0/0.05)<br/></td><td></td><td>Author Affiliation(0.0/0)<br/></td><td>(x)Commit Activity(204.0/71)<br/></td><td></td></tr>  </tbody></table> |
| Security | <hr> |
...
| Dependencies | <hr> |
| Published Software Bill of Materials | SPDX-2.3,Tool: protobom-v0.0.0-20250902230112-3b6330baf42b+dirty,Tool: GitHub.com-Dependency-Graph<br>Language package managers detected: 1 githubactions, 1 github |
...
| Commits | Days since last commit: (x)1433 days, on Sun Oct  3 08:39:03 UTC 2021, reported 0 days ago<br>Days since first commit: 1588 days, on Sat May  1 07:39:42 UTC 2021, reported 0 days ago<br>Activity: (x)0/10 with 0 commit(s) and 0 issue activity found in the last 90 days -- score normalized to 0 with most recent activity being 204 weeks (x)over the 71 week threshold |
...
| Created | Fri Sep  5 19:19:42 UTC 2025 |
| Version | pubRel 250905 (branch: publicRelease) |
| Analysis Source | Package SBOM: opa-restful_ghapi_sbom.json, 5d2dd5bc915859b7c8d83573abc4fa07 |
| Analysis ID | SBOM created on 2025-09-05T19:18:41Z (complete) |
| Runtime | Approximately 1 minute(s) (this run), for a total of 1 minute(s) over 1 run(s) |
| Command line | /home/hc_user/.local/bin/scir-oss.sh analyze -l -v -C oparest -G go-training/opa-restful -P github:sbom |
...
| Powered by | OSSF/Scorecard v5.2.1, OSSF/Critical Score unknown, MITRE Hipcheck 3.4.0, grype 0.98.0 db v6.1.0 built on 2025-09-05T17:16:30Z , OFAC SDN last updated 2025-09-04 |
