...
| Current as of | Date: 08-19-2025 (project queried 1 days ago) |
...
| Dependencies | <hr> |
| Published Software Bill of Materials | SPDX-2.3,Tool: protobom-v0.0.0-20250815191555-4e1e16745a4d+dirty,Tool: GitHub.com-Dependency-Graph<br>Language package managers detected: 1 githubactions, 1 github |
...
| Commits | Days since last commit: (x)1415 days, on Sun Oct  3 03:39:03 CDT 2021, reported 1 days ago<br>Days since first commit: 1570 days, on Sat May  1 02:39:42 CDT 2021, reported 1 days ago<br>Activity: (x)0/10 with 0 commit(s) and 0 issue activity found in the last 90 days -- score normalized to 0 with most recent activity being 202 weeks (x)over the 71 week threshold |
...
| Created | Tue Aug 19 12:38:04 CDT 2025 |
| Version | pubRel 250818 (branch: publicRelease) |
| Analysis Source | Package SBOM: opa-restful_ghapi_sbom.json, d98f1f9f6c82c15440d7cbc8a976ad74 |
| Analysis ID | SBOM created on 2025-08-18T14:29:52Z (complete) |
| Runtime | Approximately 0 minute(s) (this run), for a total of 0 minute(s) over 0 run(s) |
| Command line | /data/src/public/scir-oss/scir-oss.sh -C oparest -G go-training/opa-restful -P github:sbom -p -v |
...
| Powered by | OSSF/Scorecard v5.0.0-143-g3220bff3, OSSF/Critical Score v1.0.8, MITRE Hipcheck 3.3.1, grype 0.91.0 db v6.0.3 built on 2025-08-18T04:21:36Z  |
