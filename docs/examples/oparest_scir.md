...
| Current as of | Date: 10-03-2025 (project queried 0 days ago) |
...
| Number of Abandoned Project(s) | opa-restful is not archived; (!)primary dependencies were not checked. (see -D); (!)tertiary (other) dependencies were not checked. (see -D) |
...
| Created | Fri Oct  3 18:00:56 CDT 2025 |
| Version | pubRel 251003 (branch: publicRelease) |
| Analysis Source | Package SBOM: opa-restful_ghapi_sbom.json, 544b2656c2b46044751f1d4a84e84226 |
| Analysis ID | SBOM created on 2025-10-03T22:59:43Z (complete) |
| Runtime | Approximately 1 minute(s) (this run), for a total of 1 minute(s) over 1 run(s) |
| Command line | /data/src/scrmlab/scir-oss/scir-oss.sh analyze -l -v -C oparest -G go-training/opa-restful -P github:sbom |
...
| Powered by | OSSF/Scorecard v5.0.0-143-g3220bff3, OSSF/Critical Score v1.0.8, MITRE Hipcheck 3.3.1, grype 0.99.1 db v6.1.1 built on 2025-10-03T06:08:41Z , OFAC SDN last updated 2025-10-01 |
